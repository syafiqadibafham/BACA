...
public class crown3 extends AppCompatActivity {
    ImageView castle1Button, itemCrown3ImgV, nextButtonImgV;
    TextView itemCrown3TextV, letterCrown3TextV;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_crown3);
        ...
        castle1Button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(crown3.this, Castle1Activity.class);
        ...
        listLetter[3] = "Ll";
        //list item image
        imgArr.add(R.drawable.iron);
        imgArr.add(R.drawable.jug);
        imgArr.add(R.drawable.kettle);
        imgArr.add(R.drawable.lamp);

        x = 0;

        //set Letter appearance
        letterCrown3TextV = findViewById(R.id.letterCrown3);
        final SpannableStringBuilder sbLetter = new SpannableStringBuilder(listLetter[x]);
        letterCrown3TextV.setText(sbLetter);

        //set text appearance
        itemCrown3TextV = findViewById(R.id.crown3ItemTextView);
        ...
        itemCrown3TextV.setText(sb);

        //set image
        itemCrown3ImgV = findViewById(R.id.itemCrown3ImageView);
        itemCrown3ImgV.setImageResource(imgArr.get(x));
